...
import { Users, UserCircle, LogIn, LogOut, MessageCircle, Sparkles, Menu, X, Code2, Blocks, CodeSquare, CodeSquareIcon, GitBranchIcon, Network, Puzzle, Laptop2, LaptopIcon, CloudDrizzle, CurlyBraces, FileCode2Icon, LucideGitPullRequestClosed, GitPullRequestClosed, ActivityIcon, LucideUtensilsCrossed, ConeIcon, BluetoothConnectedIcon, BoxesIcon } from 'lucide-react';
...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-md shadow-lg"
    >
        ...
        <div className="flex h-14 sm:h-16 items-center justify-between">
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <BoxesIcon className="h-6 w-6 sm:h-7 sm:w-7 text-blue-600 group-hover:text-blue-800 transition-colors" />
            </motion.div>
